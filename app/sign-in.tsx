    ...
    <SafeAreaView className='bg-accent-100 h-full'>
      <ScrollView contentContainerClassName='h-full'>
        ...
        <View className="px-10">
          ...
          <Text className='text-3xl text-center font-bold font-rubikBold text-black-300 mt-2'>Let's Get You Closer to {'\n'} 
          ...
          <TouchableOpacity
            onPress={handleLogin}
            className="bg-white shadow-md shadow-black-100 border rounded-full w-full py-4 mt-5"
          >
